...
public class MathCalcTests {
    ...
    void sum() throws Exception {
        ...
        BigDecimal testResult = new BigDecimal(new MathCalc(expression).calculateExpression(), context);
    ...
    void SyntaxErrorTest() {
        ...
        Exception exception = Assertions.assertThrows(Exception.class, () -> new MathCalc(expression1).calculateExpression());
        Assertions.assertEquals("Syntax Error", exception.getMessage());

        String expression2 = "";
        exception = Assertions.assertThrows(Exception.class, () -> new MathCalc(expression1).calculateExpression());
        Assertions.assertEquals("Syntax Error", exception.getMessage());
    }
    ...
    void divisionZeroTest() {
        ...
        Exception exception = Assertions.assertThrows(Exception.class, () -> new MathCalc(expression).calculateExpression());
    ...
    void negativeLogTest() {
        ...
        exception = Assertions.assertThrows(Exception.class, () -> new MathCalc(expression2).calculateExpression());
        Assertions.assertEquals("-Infinity", exception.getMessage());

        String expression3 = "ln(-10)";
        exception = Assertions.assertThrows(Exception.class, () -> new MathCalc(expression3).calculateExpression());
        Assertions.assertEquals("Log from negative value", exception.getMessage());
    }
